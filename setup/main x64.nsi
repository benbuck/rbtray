...
# Define warning text for closing the uninstallation
...
!define MUI_COMPONENTSPAGE_TEXT_COMPLIST "Note: In no hook method, right click won't work. Only Alt-Shift-Down will work."
...
# By default, auto start using the hook method.
